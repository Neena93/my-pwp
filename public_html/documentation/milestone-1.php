...
<html>
	...
	<body>
		<h1>Purpose, Audience and Goal</h1>
			<p><strong>Purpose:</strong> I am using this project to promote myself as a software developer to potential employers.</p>
			<br>
		...
		<img src ="images/issa-rae-edit.jpg" width="400" height="400" alt="Issa Rae">
			...
			<br>
			<p><strong>Profession:</strong> Manager at KittyCodeABQ in search of a full-time junior developer who specializes in creating databases.</p>
			<br>
			<p><strong>Technology:</strong> Felicitas has a Pixel XL, running Oreo  and her choice web browser is Orfox. Her prefered PC is Mac while in the office and while home she prefers her self-made desktop computer. </p>
			<br>
			<p><strong>Attitudes and Behaviors:</strong> Short staffed, stressed because staff are overworked. Felicitas does not have much time outside of work to view and print individual resumes in order to find an employee. However, Felicitas is able to view digital websites as she is a frequent web browser and heavy social media websites.</p>
			<br>
